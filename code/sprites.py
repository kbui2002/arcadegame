...
class Player(Generic):
	def __init__(self, pos, assets, group, collision_sprites, jump_sound,heart):
...
class Hunter(Generic):
	...
	def move(self, dt):
		right_gap = self.rect.bottomright + vector(1.5,1)
		right_block = self.rect.midright + vector(1.5,0)
		left_gap = self.rect.bottomleft + vector(-1.5,1)
		left_block = self.rect.midleft + vector(-1.5,0)
