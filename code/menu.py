...
class Menu:
	...
	def create_buttons(self):
		...
		self.save_button_rect = generic_button_rect.move(self.rect.height / 2,-100).inflate(-button_margin,-button_margin)
		self.load_button_rect = generic_button_rect.move(self.rect.height / 10 - 20 ,self.rect.width / 10 - 118).inflate(-button_margin,-button_margin)
